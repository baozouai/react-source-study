...
export type ModuleMetaData = mixed; // eslint-disable-line no-undef
...
export type Source = mixed; // eslint-disable-line no-undef

export type UninitializedModel = string;
export const parseModel = $$$hostConfig.parseModel;

export type StringDecoder = mixed; // eslint-disable-line no-undef
